...
flags = tf.app.flags
gpu_num = 1
offset = 101 #train offset of steps already done
...
def run_training():
    ...
    train_writer = tf.summary.FileWriter('./visual_logs/train_rgb_scratch_10000_6_64_0.0001_decay_model1_resume', sess.graph)
    test_writer = tf.summary.FileWriter('./visual_logs/test_rgb_scratch_10000_6_64_0.0001_decay_model1_resume', sess.graph)
