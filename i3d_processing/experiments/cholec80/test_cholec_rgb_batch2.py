...
def run_training():
    ...
    pre_model_save_dir = "./models/rgb_imagenet_batch2_batch32_gradsub_imbdataplus"
    test_list_file = '../../list/chollec80_processed_list_test_rgb_full_batch2.txt'
    ...
    for step in xrange(all_steps):
        ...
        predicts = []
        top1 = False
        val_images, _, val_labels, exists = input_test.import_label_rgb_batch2(
